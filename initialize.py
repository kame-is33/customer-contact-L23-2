...
def initialize_agent_executor():
    ...
    # 組織図検索用のChainを作成
    st.session_state.org_chart_doc_chain = utils.create_rag_chain(ct.DB_ORG_CHART_PATH)
    ...
    tools = [
        ...
        # 組織図検索用のTool
        Tool(
            name=ct.SEARCH_ORG_CHART_TOOL_NAME,
            func=utils.run_org_chart_doc_chain,
            description=ct.SEARCH_ORG_CHART_TOOL_DESCRIPTION
        ),
        # Web検索用のTool
        Tool(
